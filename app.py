...
def gallery():
    ...
    return render_template('gallery.html', image_names=image_names, acad_images=acad_images, even_images=even_images, infra_images=infra_images, sport_images=sport_images) 
